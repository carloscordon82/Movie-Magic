const template = (ticket) => {
  let description = `<b>Movie:</b> ${ticket.movie.title}<br>
  <b>Date:</b> ${ticket.date}<br>
  <b>Time:</b> ${ticket.time}<br>
  <b>Seat:</b> ${ticket.seatNumber}<br>`;
  ...
  * {
  ...
  <div class="u-row-container" style="padding: 0px;background-color: transparent">
    <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #90b0ca;">
      <div style="border-collapse: collapse;display: table;width: 100%;background-image: url(https://image.tmdb.org/t/p/original${ticket.movie.backdrop});background-repeat: no-repeat;background-position: center top;background-color: transparent; background-size:cover">
  ...
  <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="line-height: 140%; text-align: center; word-wrap: break-word;">
      <p style="font-size: 8px; line-height: 140%;"><strong><span style="font-size: 44px; line-height: 61.6px;"><span style="font-size: 24px; line-height: 32.2px; color: #ffffff;">Your Ticket details are below</p>
    </div>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
        ...
        <img class="small-poster" align="center" border="0" src="https://image.tmdb.org/t/p/original/${ticket.movie.poster}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 186px;" width="186"/>
  ...
  <table id="u_content_text_3" style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="color: #05559a; line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><strong><span style="line-height: 25.2px; font-size: 18px;">${description}</span></strong></span></p>
    </div>
  ...
  <table style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 18px; line-height: 25.2px;"><strong><span style="line-height: 25.2px; font-size: 18px;">moviemagic.com</span></strong></span></p>
    </div>
  ...
  <table id="u_content_text_14" style="font-family:'Lato',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="color: #ffffff; line-height: 140%; text-align: center; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 12px; line-height: 16.8px;">Copyright &copy; year Movie Magic</span></p>
    </div>
